...
namespace Vertica.Integration.Infrastructure.Remote.Ftp
{
	...
	public class FtpClientException : Exception
	{
		...
		public FtpClientException(string method, string currentPath, Exception inner) : this(string.Format("Method '{0}' failed. Path: '{1}'. Message: {2}. See inner exception for more details.", method, currentPath, inner.Message), inner)
		{
		}
