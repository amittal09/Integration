...
namespace Vertica.Integration.Infrastructure.Factories.Castle.Windsor.Installers
{
	public static class Install
	{
		public static ConventionInstaller ByConvention
		{
			get
			{
				return new ConventionInstaller();
			}
		}
		...
		public static IWindsorInstaller Instance<T>(T instance)
		where T : class
		{
		...
		public static IWindsorInstaller Type<TService>(Type type, Action<ComponentRegistration<TService>> registration = null)
		where TService : class
		{
